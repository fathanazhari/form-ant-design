...
var App = /** @class */ (function (_super) {
    ...
    function App() {
        ...
        _this.handleSelectChange = function (value) {
            ...
            _this.props.form.setFieldsValue({
                welcome: "Selamat Datang, " + (value === 'hasansadikin' ? 'di rumah sakit hasansadikin' : 'di rumah sakit sentosa') + ":)",
            });
        };
        return _this;
    }
    App.prototype.render = function () {
        ...
        return (React.createElement(Form, { labelCol: { span: 5 }, wrapperCol: { span: 8 }, onSubmit: this.handleSubmit },
            React.createElement(Form.Item, { label: "Welcome" }, getFieldDecorator('welcome', {
                rules: [{ required: true, message: 'Please input your rumahsakit:)' }],
            })(React.createElement(Input, null))),
            React.createElement(Form.Item, { label: "Rumahsakit" }, getFieldDecorator('rumahsakit', {
                rules: [{ required: true, message: 'Please select your rumahsakit!' }],
            })(React.createElement(Select, { placeholder: "Select a option and change input text above", onChange: this.handleSelectChange },
                React.createElement(Option, { value: "hasansadikin" }, "hasansadikin"),
                React.createElement(Option, { value: "sentosa" }, "sentosa")))),
